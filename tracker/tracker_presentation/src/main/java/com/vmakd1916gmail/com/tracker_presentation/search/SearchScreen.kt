...
import com.vmakd1916gmail.com.tracker_presentation.search.components.SearchTextField
import com.vmakd1916gmail.com.tracker_presentation.search.components.TrackableFoodItem
...
fun SearchScreen(
    ...
    Column(
        ...
        SearchTextField(
            text = state.query,
            shouldHint = state.isHintVisible,
            onValueChange = {
